//
//  ZYTableSectionHeaderTitle_View.m
//  JSGL
//
//  Created by XUZY on 2021/10/18.
//

#import "ZYTableSectionHeaderTitle_View.h"

@interface ZYTableSectionHeaderTitle_View ()
...
@implementation ZYTableSectionHeaderTitle_View
...
- (void)setCellType:(TableSectionHeaderTitleCellType)cellType {
    if (_cellType != cellType) {
        _cellType = cellType;
        if (_cellType == TableSectionHeaderTitleCellTypeText) {
            [self.moreButton removeFromSuperview];
            self.moreButton = nil;
            [self.titleLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
                make.edges.mas_equalTo([self titleLabelEdge]);
            }];
        }else if (_cellType == TableSectionHeaderTitleCellTypeTextButton) {
